'use client';
// Source: React Bits (reactbits.dev, MIT + Commons Clause), LogoLoop-TS-TW. Local edits marked 'edu:'.
...
const useAnimationLoop = (
  ...
  useEffect(() => {
    ...
    const animate = (timestamp: number) => {
      ...
      rafRef.current = onScreen ? requestAnimationFrame(animate) : null;
    };

    // edu: only animate while the loop is on screen
    let onScreen = true;
    const io = new IntersectionObserver(([entry]) => {
      onScreen = entry.isIntersecting;
      if (onScreen && rafRef.current === null) {
        lastTimestampRef.current = null;
