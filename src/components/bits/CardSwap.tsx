'use client';
// Source: React Bits (reactbits.dev, MIT + Commons Clause), CardSwap-TS-TW. Local edits marked 'edu:'.
import React, {
  Children,
  cloneElement,
  forwardRef,
...
export interface CardSwapProps {
  ...
  /** edu: false keeps the stack still (weak devices, reduced motion) */
  animate?: boolean;
  className?: string;
  children: ReactNode;
}
...
const CardSwap: React.FC<CardSwapProps> = ({
  ...
  useEffect(() => {
    ...
    // edu: only swap while the stack is on screen
    let visible = false;
    const start = () => {
  ...
  }, [cardDistance, verticalDistance, delay, pauseOnHover, skewAmount, easing, animate]);
  ...
  return (
    <div
      ref={container}
      // edu: positioning is left to the caller
